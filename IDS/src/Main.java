public class Main {
	...
	public static void main(String[] args) {
		int depth = 2;
		Graph graph = new Graph(11);		//number of total nodes is sent as argument
...
//        graph.addNode(node);
		...
		Node node = new Node(0, new int[] {1, 2});
		graph.addNode(node);
		
		node = new Node(1, new int[] {0, 3, 4});
		graph.addNode(node);
		
		node = new Node(2, new int[] {0});
		graph.addNode(node);
		
		node = new Node(3, new int[] {1, 5});
		graph.addNode(node);
		
		node = new Node(4, new int[] {1, 6, 7});
		graph.addNode(node);
		
		node = new Node(5, new int[] {3, 8, 9});
		graph.addNode(node);
		
		node = new Node(6, new int[] {4});
		graph.addNode(node);
		
		node = new Node(7, new int[] {4});
		graph.addNode(node);
		
		node = new Node(8, new int[] {5, 10});
		graph.addNode(node);
		
		node = new Node(9, new int[] {5});
		graph.addNode(node);
		
		node = new Node(10, new int[] {8});
		graph.addNode(node);
        
		while(depth<=10){
			if(graph.ids(0, 10, depth)){	//source, destination, depth
